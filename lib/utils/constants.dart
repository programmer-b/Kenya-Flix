...
import 'package:kenyaflix/screens/home_screen.dart';
...
const kDrawerTitleThirdText = "CONTACT";
const kAppliedTheme = "Theme applied";
const kNotFoundErrorText = "Not found";
const kDrawerAboutDescText =
    "KenyaFlix app is a way to store and keep track of all your movies. Collect, filter and search movies by your favorite genres and actors, making finding the perfect movie just a tap away. Forget searching through endless folders of titles, store your whole movie collection in one place to make browsing a breeze.";
const kDrawerDependenciesDescText =
    "\t• programmerdante@gmail.com\n\t• https://github.com/programmer-b\n\t";
