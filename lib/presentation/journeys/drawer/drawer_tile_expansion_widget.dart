...
import 'package:kenyaflix/presentation/journeys/drawer/drawer_tile_container_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DrawerTileWidget(
        ...
        overrideColor: isSelected ? Theme.of(context).colorScheme.secondary : null,
      ),
    );
  }
}
